            ...
            once: true
              ...
              <>
                  ...
                  <div className="aspect-square overflow-hidden rounded-sm">
                    <img src="https://static-us-img.skywork.ai/prod/user/head_picture/2025924216409608192_about1.jpg?image_process=quality,q_90/resize,w_1280/format,webp" alt={language === 'zh' ? '现代建筑美学' : 'Modern Architecture'} className="w-full grayscale hover:grayscale-0 transition-all duration-500 h-[389.328125px] object-cover" />
                  </div>
